              ...
              <div className='md:px-12 pl-4'>
                ...
                <div>
                  <ul className='flex flex-col gap-3'>
                    <li className='flex items-center gap-3'>Posted By: <div>Farhan Jafri</div></li>
                    <li className='flex items-center gap-3'>Posted At: <div>21-08-2024</div></li>
                    <li className='flex items-center gap-3'>Location: <div> Islamabad, Pakistan</div></li>
                    <li className='flex items-center gap-3'>Salary: <div className='flex items-center' >Rs.<span>{(jobDetails.salary  / 100000).toFixed(0)} LPA</span></div></li>
