        ...
        <div className="flex flex-col gap-5 md:px-0 px-2 md:pt-8 pt-4 pb-20">
          <div>
            ...
            <p>
              ...
              engagement with our platform are our top priorities.
            </p>
          </div>
          ...
          <div>
            ...
            <Card
              title="Address"
              content="JobJunction, DHA Phase V, Lahore, Pakistan"
            />
            <Card
              title="Email"
              content={[
                "General Inquiries: info@jobjunction.com",
                "Support: support@jobjunction.com",
                "Job Applications: jobs@jobjunction.com",
              ]}
            />
            <Card
              title="Phone"
              content={[
                "Customer Support: 0312-9876543",
                "HR & Job Inquiries: 0312-3456789",
              ]}
            />
