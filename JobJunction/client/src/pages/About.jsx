  ...
  return (
    <>
      ...
      <div className="bg-gray-900 min-h-screen pt-14 md:px-20 px-3 text-white">
        <div className="flex flex-col items-center md:pt-8 pt-4 pb-20">
          <div className="bg-gray-800 p-5 rounded-lg shadow-lg mb-5 w-full max-w-2xl">
            <p className="text-4xl pb-3 font-bold text-center text-yellow-500">About Us</p>
            <p className="text-lg">
              At JobJunction, we're more than just a job application platform –
              ...
              seasoned professional seeking new horizons, JobJunction is here to
          ...
          <div className="bg-gray-800 p-5 rounded-lg shadow-lg w-full max-w-2xl">
            <p className="text-2xl text-yellow-500 text-center">Join the JobJunction Community</p>
            <p className="pt-3">
              When you join JobJunction, you're not just signing up for a platform –
            ...
            <p className="pt-4">
              Thank you for choosing JobJunction as your partner in career
